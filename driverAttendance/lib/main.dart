...
Future<void> _firebaseMessagingBackgroundHandler(RemoteMessage message) async {
  // cekSound(true);
  displayIncomingCall(Uuid().v4(), message);
...
Future<void> displayIncomingCall(String uuid, RemoteMessage message) async {
  final config = CallKeepIncomingConfig(
    ...
    appName: 'Absensi Driver',
    handle: message.notification?.body,
    hasVideo: false,
    duration: 30000,
    acceptText: 'Accept',
    declineText: 'Decline',
...
void main() async {
  ...
  FirebaseMessaging.onMessageOpenedApp.listen((RemoteMessage message) {
    // cekSound(false);
    // Tambahkan logika untuk menangani pesan saat aplikasi dibuka dari notifikasi
  });
